...
do_action( 'woocommerce_before_mini_cart' ); ?>
    ...
    if ( ! WC()->cart->is_empty() ) : ?>
	<?php
	$woo_bew_cart = get_option('woo_bew_cart') ?? null;	
	?>								
	
	<ul class="woocommerce-mini-cart bew-mini-cart-template cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ?? null ); ?>">
		<?php
