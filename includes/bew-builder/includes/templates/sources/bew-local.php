...
class Bew_Builder_Templates_Source_Local extends Bew_Builder_Templates_Source_Base {
	...
	*/
	public function get_items() {
		...
		$templates = bew_builder()->templates_manager->get_templates_list();
		...
		foreach ( $templates as $template ) {
			...
			$structure = bew_builder()->structures->get_structure( $type );
