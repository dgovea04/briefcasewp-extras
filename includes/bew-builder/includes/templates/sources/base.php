...
abstract class Bew_Builder_Templates_Source_Base {
	...
	*/
	...
	public function templates_key() {
		return 'bew_builder_templates_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function categories_key() {
		return 'bew_builder_categories_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function keywords_key() {
		return 'bew_builder_keywords_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function is_debug_active() {
		...
		if ( defined( 'BEW_API_DEBUG' ) && true === BEW_API_DEBUG ) {
			return true;
		} else {
			return false;
		}
